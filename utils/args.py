...
def parse_with_config(parser):
    ...
    for k in ["tau1","tau2","lambda_itm"]:
        if k in cmd_cfg_keys:
            model_cfg[k] = float(getattr(args,k))
...
def get_args():
    ...
    parser.add_argument('--model_type', type=str, default='vast')
    ...
    parser.add_argument('--log_name', type=str, default='pmrl')
